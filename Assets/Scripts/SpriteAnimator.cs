...
public class SpriteAnimator : IDisposable
{
    private class Animation
    {
        ...
        ////конструктор SpriteAnimator, входной параметр которого Ч конфиг с описанием анимаций;
        public SpriteAnimator(SpriteAnimationsConfig config)
        {
            _config = config;
        }

        //старт анимации дл€ спрайта, использу€ трек, с заданной скоростью;
        ...
        //стоп анимации дл€ спрайта, нужно вызывать перед удалением спрайта;
        ...
        //Update Ч вызывайте из основного Update игры.
        public void Update()
        {
